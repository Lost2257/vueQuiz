...
/* harmony default export */ __webpack_exports__["default"] = ({
  mounted: function mounted() {
    ...
    axios.get('/api/count').then(function (response) {
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    loadQuizzes: function loadQuizzes() {
      ...
      axios.get('/api/quizzes').then(function (response) {
        _this.quizzes = response.data.data;
        _this.loading = false;
      })["catch"](function (error) {
        console.log(error);
  ...
  return _c(
    ...
    [
      ...
      _vm._l(_vm.quizzes, function(quiz) {
        return _c("p", [_vm._v(_vm._s(quiz.answer))])
      })
    ],
    2
  )
